...
var unit = (function () {
    ...
    unit.prototype.createInput = function () {
...
var dropdownUnit = (function (_super) {
    ...
    function dropdownUnit(label, convertFrom, options) {
        _super.call(this, label, convertFrom, function (a) { return a; });
        this.options = options;
    }
    dropdownUnit.prototype.createInput = function () {
...
var pitch = distance.concat([inverseMeters, inverseInches, metricCoarseThreads, USCThreads]);
